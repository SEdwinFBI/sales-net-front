    ...
    <Card className="bg-card p-4 sm:p-5">
      <div className="flex items-start justify-between gap-4">
        <div className="flex min-w-0 items-start gap-3 sm:gap-4">
          <div className={`flex size-12 shrink-0 items-center justify-center rounded-full text-lg font-bold text-white sm:size-14 ${!cliente.activo ? 'bg-muted-foreground/70' : cliente.permitir_credito === false ? 'bg-violet-600' : 'bg-emerald-600'}`}>
          ...
          <div className="min-w-0">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-1 text-sm">
              ...
              {cliente.permitir_credito === true && <span className="whitespace-nowrap text-muted-foreground">
        ...
        {cliente.permitir_credito === true && <div className="shrink-0 text-right">
