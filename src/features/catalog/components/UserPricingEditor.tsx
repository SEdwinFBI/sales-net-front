                ...
                <div className="p-4">
                  ...
                  {isExpanded && (
                    <div className="mt-4 grid gap-3 xl:grid-cols-[11rem_minmax(0,1fr)]">
                      <div className="flex items-center gap-3 rounded-lg border border-border bg-muted/20 p-3 xl:block">
                        <ArticleImage
                          className="size-14 shrink-0 rounded-md object-cover shadow-sm xl:aspect-square xl:size-auto xl:w-full"
                          src={article.image}
                          alt={article.title}
                        />
                        <div className="min-w-0">
                          <p className="line-clamp-2 text-sm font-semibold xl:mt-2">{article.title}</p>
