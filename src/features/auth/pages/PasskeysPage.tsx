...
export default function PasskeysPage() {
  ...
  return (
    <PageTemplateSimple title="Passkeys" description="Administra el acceso a tu cuenta con huella, rostro o PIN.">
        ...
        <header className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <h1 className="font-heading text-2xl font-semibold">Passkeys</h1>
